...
* check an image to see if the style matches a reference image
*

Trigger keywords: match style, converge style, ___
...
### Slash command
`/image-style-converger`

### Conversational triggers
What would a user say that should activate this skill?
"can you make this X image look like the Y image?"
"can you use the style from image X to look like image Y"
...
|-------------------|----------|
| make an image match the style of another image | → match style |
