...
* Manage public pages 
* Help the user create public pages (the process)

Trigger keywords: public, static page, ___
...
### Slash command
`/skill-name managing-public-pages`
...
Should Claude fix and re-verify in a loop? Yes / No
